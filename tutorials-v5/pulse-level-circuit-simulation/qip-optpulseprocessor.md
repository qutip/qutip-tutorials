...
The interaction is generated by $\sigma_x\sigma_x$ between the qubit 0 & 1 and qubit 1 & 2.

```python
sxsx = tensor([sigmax(), sigmax()])
sxsx01 = tensor([sigmax(), sigmax(), identity(2)])
sxsx12 = tensor([identity(2), sigmax(), sigmax()])
